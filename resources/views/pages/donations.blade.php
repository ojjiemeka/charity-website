            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-md-12">
                        ...
                        <form action="{{route('donate')}}" method="post" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input form-light" type="radio" name="amount"
                                                    id="amount6" value="100">
                                                <label class="form-check-label label-dark" for="amount6">$100</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input form-light" type="radio" name="amount"
                                                    id="amount7" value="500">
                                                <label class="form-check-label label-dark" for="500">$500</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input form-light" type="radio" name="amount"
                                                    id="amount8" value="1000">
                                                <label class="form-check-label label-dark" for="1000">$1000</label>
                                            </div>
                                            <div class="mt-3">
                                                <input type="text" class="form-control" id="custom"
                                                    placeholder="Custom Amount" name="cus_amount">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <p class="text-primary">Thank you for considering a donation to [Your Charity Name]. Your support is crucial in helping us provide assistance to homeless individuals, displaced communities, and wildlife conservation efforts.</p>
                                        <p>
                                            At [Your Charity Name], we respect your privacy. Donations are anonymous by default. If you prefer to be recognized for your contribution, please uncheck the anonymous option before completing your donation.
                                        </p>
                                        <p>
                                            Your generosity makes a significant impact on the lives of homeless individuals, displaced communities, and the preservation of wildlife. We deeply appreciate your support and dedication to creating positive change.
                                        </p>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <select class="theme-combo donation-select" name="country" style="height: 400px">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <select class="theme-combo donation-select" name="anon_state" style="height: 400px">
